...
<body id="page-top" style="background-color: #f8c7fa;">
    ...
    <section id="download" class="download-section content-section text-center" style="background-image:url('../assets/img/notebook.jpg');">
        <div class="container">
			...
			<div>
				<?php  if (isset($_SESSION['user'])) : ?>
					...
					<small>
                       ...
                       &nbsp; <a href="create_user.php"> + add a tutor or learner</a>
                       &nbsp; <a href="module_details.php"> + add modules and assign tutors</a>
					   &nbsp; <a href="display.php"> + display module content</a>
					   &nbsp; <a href="addbookauthor.php"> + enroll learners to modules</a>
					   &nbsp; <a href="enrol.php"> + view list of modules and learners</a>
					</small>
